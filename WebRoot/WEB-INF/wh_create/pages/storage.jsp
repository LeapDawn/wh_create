	...
	<div class="content">
		<div class="content-nav" style="min-height:516px;">
			<ul class="nav nav-pills nav-stacked">
			    ...
			    <li role="presentation" class="active"><a href="${fyForwardUrl}&forwardPage=storage.jsp"><span class="fa fa-arrow-right"></span> 货架列表</a></li>
		...
		<div class="content-main">
			...
			<div class="tools">
				...
				<div class="operation">
					<button type="button" class="btn btn-success" id="addBtn"><span class="fa fa-plus"></span> 新增货架</button>
				</div>
			</div>
			...
			<div class="panel panel-default">		
				...
				<div class="panel-body">
			      	  <form class="form-horizontal">
			      	  	<div class="form-group">
			    	  	  	  <label for="" class="col-md-2 control-label" style="font-weight:normal;">货架名称</label>
			    	  	  	  <div class="col-md-4">
			    	  	  	    <input type="text" class="form-control" id="shName" readonly>
			    	  	  	  </div>&nbsp;&nbsp;&nbsp;
			      	  	...
			      	  	<div class="form-group">
			    	  	  	  ...
			    	  	  	  <div class="col-md-4">
			    	  	  	    <textarea type="text" class="form-control" id="shRemark" rows="4" readonly></textarea>
			    	  	  	  </div>
			      	  	</div>
			      	  </form>
...
<!-- 			 			<th>备注</th> -->
	...
	<script src="${resourceUrl}js/storage.js"></script>
</body>
</html>